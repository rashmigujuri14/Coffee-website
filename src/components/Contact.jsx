    ...
    return (
        <div id='contact' style={bgImage} className='min-h-screen flex items-center justify-center p-6'>
            <motion.div
                ...
                <p className='text-center text-lg text-white-600 mb-8 font-cursive'>We would love to hear from you! Fill out the form below and we’ll get back to you as soon as possible.</p>
                <form className='space-y-6'>
                    ...
                    <div>
                        <label htmlFor="message" className='block text-sm font-medium text-white-700 mb-1'>Message</label>
...
<div className='mt-8 text-center relative max-w-xs mx-auto rounded-xl overflow-hidden'>
    <div className='absolute inset-0 bg-black opacity-50'></div> {/* Overlay for better contrast */}
    <p className='text-white text-sm sm:text-base font-medium relative z-10'>
        Feel free to contact us directly:
    </p>
    <p className='font-semibold text-white text-sm sm:text-base relative z-10 mt-1'>
    +1 (123) 456-7890
</p>
<p className='font-semibold text-white text-sm sm:text-base relative z-10 mt-1'>
