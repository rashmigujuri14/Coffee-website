        ...
        <div className='from-slate-100 to-amber-950 bg-gradient-to-r mt-14'>
            <div className='max-w-7xl mx-auto grid md:grid-cols-2 place-items-center h-[700px] md:h-[650px] relative pt-10 md:pt-0'>
                ...
                <div className='space-y-5 px-4 md:px-0'>
                    ...
                    className='text-amber-900 font-semibold font-cursive text-lg'>Welcome to BeanCraft___</motion.h3>
                    <motion.h1 
                     initial={{opacity:0,x:-60}}
                     whileInView={{opacity:1,x:0}}
                     transition={{duration:1, delay:0.4}}
                    className='text-4xl md:text-6xl font-bold font-cursive2'>Experience Artisanal <span className='text-amber-900'>Coffee</span> at Bean-craft</motion.h1>
                    <motion.p
                     initial={{opacity:0,x:-60}}
                     whileInView={{opacity:1,x:0}}
