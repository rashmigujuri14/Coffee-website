...
const MenuData = [
    {
      ...
      name: "Espresso",
      description:
        "A coffee break isn't just a pause—it's a moment to reawaken, refocus, and refresh the mind.",
    },
    {
      id: 2,
      img: Img1,
      name: "Americano",
      description:
        "The perfect cup of coffee doesn’t just fuel the body—it nourishes the mind and stirs the soul."
    },
    {
      id: 3,
      img: Img2,
      name: "Cappuccino",
      description:
        "A good cup of coffee isn’t just a drink; it’s the beginning of endless possibilities waiting to unfold.",
    },
  ];
